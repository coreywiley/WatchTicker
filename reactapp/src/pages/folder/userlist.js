...
class UserList extends Component {
    ...
    form_submit(result) {
        ...
        ajaxWrapper('POST','/api/email/', {'to_email': result[0]['user']['email'], 'from_email':'jeremy.thiesen1@gmail.com', 'subject':'You are invited to Watch Ticker', 'text': "You've been invited to join Watch Ticker. Set up your password <a href='https://watchticker.jthiesen1.webfactional.com/passwordReset/" + result[0]['user']['id'] + "/'>here.</a>"}, console.log)
    }
        ...
        return (<div className="container">
            ...
            <TableWithChildren headers={['Email', 'Is Admin', 'Edit', 'Delete']} required={""} order={"3"} >
			         <ListWithChildren dataUrl={"/api/user/User/"} objectName={"User"} table={"true"} style={{}} required={""} parent={"2"} >
        				...
        				<Button text={"Delete"} type={"danger"} style={{}} functions={[['ajaxWrapper', {'type': 'POST', 'url': '/api/user/user/{props.id}/delete/', 'data': {}}], ['setGlobalState', {'deleteFunction': true}]]} required={""} parent={"5"} />
                    </ListWithChildren>
                </TableWithChildren>
