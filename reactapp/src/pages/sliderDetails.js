...
class EmojiSliderDetails extends Component {
    ...
    render() {
      ...
      <Paragraph text={'<iframe src="https://admin.slidemoji.com/slider/' + this.props.slider + '/" width="' + this.state.emojiForm.width + '" frameBorder="0" height="300px" scrolling="no" seamless>Browser not compatible.</iframe>'} />
