...
class Customers extends Component {
    ...
    componentDidMount() {
      ...
      ajaxWrapper('GET','/api/home/order/?related=food_item,food_item__prep_list&event=' + this.props.event_id, {}, this.eventCallback)
    }
    ...
    eventCallback(result) {
      ...
      for (var index in result) {
        var shoppinglist = result[index]['order']['food_item']['prep_list']
    ...
    render() {
      ...
      for (var index in this.state.orders) {
        ...
        var renderItem = <div className="col-md-6" style={{'marginBottom':'25px'}}><div style={{'color':'#473ec4'}}><Header size={5} text={this.state.orders[index][0]}  /></div> {todolist} <br /></div>;
      ...
      var content =
        ...
        <div style={{'marginTop':'25px'}}>
          ...
          <Header css={{'padding':'50px','color':'#473ec4', 'text-align':'center'}} size={1} text={'Prep List for ' + this.state.eventInfo.name} />
          {eventInfo}
