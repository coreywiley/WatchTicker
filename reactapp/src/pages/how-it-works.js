...
class Home extends Component {
    ...
    render() {
      ...
      <div style={{"background-image": "url(http://beta.patrongate.com/wp-content/uploads/2018/01/page-how-it-works-featured-image.jpg)"}} class="page-cover page-cover--default has-image">
      ...
      <div class="entry-content container" style={{'fontSize':'20px', marginTop:'30px'}}>
          ...
          <p><img class="size-full aligncenter" src="http://beta.patrongate.com/wp-content/uploads/2018/01/page-how-it-works-3.png" width="220px" /><br />
          Visit our '<a href="http://beta.patrongate.com/add-your-listing/">add your business listing</a>' page and enter your information. Our representatives will follow up to confirm your information is correct and you are indeed the owner of the business.</p>
          ...
          <p><img class="size-full aligncenter" src="http://beta.patrongate.com/wp-content/uploads/2018/01/page-how-it-works-1.png" width="180px" /></p>
          <h3></h3>
          ...
          <div style={{'text-align':'center'}}>
            <Button type={'patron'} href={"http://beta.patrongate.com/add-your-listing/"} text={"Get Started Now"} css={{'fontSize':'15px', paddingLeft: '50px', paddingRight:'50px', paddingTop:'15px', paddingBottom: '15px', marginBottom:'30px'}} />
          </div>
      </div>
      </div>
