...
class SignUp extends Component {
    ...
    render() {
        ...
        var email_props = {'value':'','name':'email','label':'Email','placeholder': '', 'required':true};
        var password_props = {'confirm_password':true, 'required':true};
        var phone =  {'value':'','name':'phone','label':'Phone Number','placeholder': ''};
        ...
        var zipcode =  {'value':'','name':'zipcode','label':'Zip Code','placeholder': ''};
