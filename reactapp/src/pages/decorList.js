...
class Customers extends Component {
    ...
    render() {
      ...
      for (var index in this.state.orders) {
        ...
        var renderItem = <div className="col-md-6" style={{'marginBottom':'25px'}}><div style={{'color':'#7d2491'}}><Header size={5} text={this.state.orders[index][0]}  /></div> {todolist} <br /></div>;
      ...
      var content =
        ...
        <div style={{'marginTop':'25px'}}>
          ...
          <Header css={{'padding':'50px','color':'#7d2491', 'text-align':'center'}} size={1} text={'Decoration List for ' + this.state.eventInfo.name} />
          {eventInfo}
          <div style={{'marginTop':'35px','marginBottom':'50px'}}>
          <Header size={2} text={'Decoration List'} />
          </div>
          <div className="row">
          {renderList}
          </div>
