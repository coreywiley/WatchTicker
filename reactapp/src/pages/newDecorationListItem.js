...
class NewMenuItem extends Component {
    ...
    componentDidMount() {
      ...
      if (this.props.shoppinglistitem_id) {
        ajaxWrapper('GET','/api/home/decorationlistitem/' + this.props.shoppinglistitem_id + '/', {}, this.eventCallback)
      }
      else {
    ...
    eventCallback(result) {
      ...
      var customerDetails = result[0]['decorationlistitem'];
    ...
    render() {
      ...
      var submitUrl = '/api/home/decorationlistitem/';
      if (this.props.shoppinglistitem_id) {
        submitUrl += this.props.shoppinglistitem_id + '/';
      }
      var redirectUrl = '/decorationListItems/' + this.props.fooditem_id;


      var content =
        <div className={'container'}>
          <Header size={2} text={'Create New Decoration List Task for ' + this.state.fooditem.name} />
          <p><Link text={'Back to Decoration List.'} link={'/decorationListItems/' + this.state.fooditem.id + '/'} /></p>
