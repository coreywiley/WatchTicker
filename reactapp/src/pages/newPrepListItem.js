...
class NewMenuItem extends Component {
    ...
    componentDidMount() {
      ...
      if (this.props.shoppinglistitem_id) {
        ajaxWrapper('GET','/api/home/preplistitem/' + this.props.customer_id + '/', {}, this.customerCallback)
      }
      else {
    ...
    render() {
      ...
      var content =
        <div className={'container'}>
          <Header size={2} text={'Create New Prep List Task for ' + this.state.fooditem.name} />
