...
class Customers extends Component {
    ...
    componentDidMount() {
      ...
      ajaxWrapper('GET','/api/home/preplistitem/?food_item=' + this.props.fooditem_id, {}, this.eventCallback)
    }
    ...
    eventCallback(result) {
      ...
      for (var index in result) {
        eventList.push(result[index]['preplistitem'])
      }
    ...
    deleteEvent(id) {
      console.log(id)
      ajaxWrapper('GET', '/api/home/preplistitem/' + id + '/delete/', {}, this.deleteEventCallback)
    }
    ...
    render() {
      ...
      for (var index in this.state.eventList) {
        ...
        var row = <tr>
                      ...
                      <td><Button type={'info'} text={'Edit'} href={'/newPrepListItem/' + this.props.fooditem_id + '/' + this.state.eventList[index]['id'] + '/'} /></td>
      ...
      var content =
        <div className='container'>
          <Header size={2} text={'Prep List Items for ' + this.state.fooditem.name} />
          <p><Link text={'Back to Menu Items List.'} link={'/menuItems/'} /></p>
          <table className='table'>
            <tr>
              <th>Prep List Items</th>
              <th>Edit</th>
              <th>Delete</th>
            </tr>
            <tr>
