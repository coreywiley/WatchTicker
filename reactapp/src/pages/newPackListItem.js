...
class NewMenuItem extends Component {
    ...
    eventCallback(result) {
      ...
      var customerDetails = result[0]['packinglistitem'];
    ...
    render() {
      ...
      var redirectUrl = '/packListItems/' + this.props.fooditem_id;


      var content =
        <div className={'container'}>
          <Header size={2} text={'Create New Pack List Task for ' + this.state.fooditem.name} />
          <p><Link text={'Back to Packing List.'} link={'/packListItems/' + this.state.fooditem.id + '/'} /></p>
