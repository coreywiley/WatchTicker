...
class Customers extends Component {
    ...
    componentDidMount() {
      ...
      ajaxWrapper('GET','/api/home/decorationlistitem/?food_item=' + this.props.fooditem_id, {}, this.eventCallback)
    }
    ...
    eventCallback(result) {
      ...
      for (var index in result) {
        eventList.push(result[index]['decorationlistitem'])
      }
    ...
    deleteEvent(id) {
      console.log(id)
      ajaxWrapper('GET', '/api/home/decorationlistitem/' + id + '/delete/', {}, this.deleteEventCallback)
    }
    ...
    render() {
      ...
      for (var index in this.state.eventList) {
        ...
        var row = <tr>
                      ...
                      <td><Button type={'info'} text={'Edit'} href={'/newDecorationListItem/' + this.props.fooditem_id + '/' + this.state.eventList[index]['id'] + '/'} /></td>
      ...
      var content =
        <div className='container'>
          <Header size={2} text={'Decoration List Items for ' + this.state.fooditem.name} />
          ...
          <table className='table'>
            ...
            <tr>
              <td><Button type={'success'} text={'Add New Task'} href={'/newDecorationListItem/' + this.props.fooditem_id +'/'} /></td>
              <td></td>
              <td></td>
            </tr>
            {eventList}
