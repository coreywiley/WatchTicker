...
class Failed extends Component {
    ...
    getQuestion(result) {
      ...
      var text = this.state.user_name + ' failed their calibration test on item: ' + question_name + '. Reach out to them at ' + this.state.user_email
      ajaxWrapper("POST", '/api/email/',{'to_email':'jeremy.thiesen1@gmail.com', 'from_email':'jeremy.thiesen1@gmail.com', 'text': text, 'subject':'Calibration Failed'}, console.log)
    ...
    render() {
        ...
        var message = "You've worked through all the calibration questions and didn't make the grade we need. An email has been sent to the administrators and they will follow up with next steps."
        var content =
        <div>
            <Nav token={this.props.user_id} logOut={this.props.logOut} />
            <div className="container">
                <Header size={'2'} text={'Keep At It'} />
